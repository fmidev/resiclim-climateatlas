...
def thermal_growing_season_length(da_t2mean_summer, basevalue):
    ...
    gsl = (gs_end - gs_beg).assign_coords(time=y).rename('gsl')
...
def rain_on_snow(da_tp, da_sf, da_snowc, rain_threshold):
    ...
    print('Calculating rain-on-snow events for '+str(y))        
    ...
    # Liquid precipitation needs to be at least 10 mm (=0.01 m)
